	...
	api.SFGuidedTour = {
		...
		_hideTour(remove) {
			...
			$('body')
				.addClass('sf-exiting')
				.on(
					'animationend.fiftyshadesfurniture webkitAnimationEnd.fiftyshadesfurniture',
					function () {
						$(this)
		...
		_moveContainer($selector) {
			...
			this.$container
				...
				.on('transitionend.fiftyshadesfurniture', function () {
					self.$container.removeClass('sf-moving')
					self.$container.off('transitionend.fiftyshadesfurniture')
				})
		},
