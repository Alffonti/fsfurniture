/* global fiftyshadesfurnitureScreenReaderText */
		...
		if (handheld.length > 0) {
			;[].forEach.call(
				...
				function (anchor) {
					...
					btnSpan.appendChild(
						document.createTextNode(fiftyshadesfurnitureScreenReaderText.expand)
					)
					...
					btn.addEventListener('click', function () {
						...
						btnSpan.appendChild(
							document.createTextNode(
								expanded
									? fiftyshadesfurnitureScreenReaderText.collapse
									: fiftyshadesfurnitureScreenReaderText.expand
							)
						)
