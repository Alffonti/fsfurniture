<?php
/**
 * Fiftyshadesfurniture functions.
 *
 * @package fiftyshadesfurniture
 */

if ( ! function_exists( 'fiftyshadesfurniture_is_woocommerce_activated' ) ) {
	/**
	 * Query WooCommerce activation
	 */
	function fiftyshadesfurniture_is_woocommerce_activated() {
 ...
 */
function fiftyshadesfurniture_do_shortcode( $tag, array $atts = array(), $content = null ) {
 ...
 * Accounts for the Fiftyshadesfurniture Designer and Fiftyshadesfurniture Powerpack content background option.
 *
 * @since  1.6.0
 * @return string the background color
 */
function fiftyshadesfurniture_get_content_background_color() {
	if ( class_exists( 'Fiftyshadesfurniture_Designer' ) ) {
		$content_bg_color = get_theme_mod( 'sd_content_background_color' );
		$content_frame    = get_theme_mod( 'sd_fixed_width' );
	}

	if ( class_exists( 'Fiftyshadesfurniture_Powerpack' ) ) {
	...
	if ( class_exists( 'Fiftyshadesfurniture_Powerpack' ) || class_exists( 'Fiftyshadesfurniture_Designer' ) ) {
...
/**
 * Apply inline style to the Fiftyshadesfurniture homepage content.
 *
 * @uses  get_the_post_thumbnail_url()
 * @since  2.2.0
 */
function fiftyshadesfurniture_homepage_content_styles() {
	...
	$styles = apply_filters( 'fiftyshadesfurniture_homepage_content_styles', $styles );
 ...
 * @since  1.0.0
 */
function fiftyshadesfurniture_adjust_color_brightness( $hex, $steps, $opacity = 1 ) {
 ...
 * @since  1.3.0
 */
function fiftyshadesfurniture_sanitize_choices( $input, $setting ) {
 ...
 * @since  1.5.0
 */
function fiftyshadesfurniture_sanitize_checkbox( $checked ) {
