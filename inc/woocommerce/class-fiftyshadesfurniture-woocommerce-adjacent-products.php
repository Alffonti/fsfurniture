<?php
/**
 * Fiftyshadesfurniture WooCommerce Adjacent Products Class
 *
...
if ( ! class_exists( 'Fiftyshadesfurniture_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Fiftyshadesfurniture WooCommerce Adjacent Products Class
	 */
	class Fiftyshadesfurniture_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'fiftyshadesfurniture_woocommerce_adjacent_query_args', $args ) );
